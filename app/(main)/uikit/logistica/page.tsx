...
const TableModule = () => {
    const [activeModule, setActiveModule] = useState('Logistica'); // El que renderiza al cargar la pagina
            ...
            {/* <h1 style={styles.title}>Tables</h1> */}
                <div className="card">
                    <div style={styles.menu}>
                        <div
                            style={activeModule === 'Logistica' ? styles.activeMenuItem : styles.menuItem}
